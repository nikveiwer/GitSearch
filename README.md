...
P.S. В некоторых случаях, при переходе на последние страницы результата поиска может возникать ошибка, так-как API предоставляет доступ только к первой 1000 найденных репозиториев. 
